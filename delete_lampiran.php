<?php
    ...
    if($id_check != null){
        ...
        echo "<script>location.replace('form_peminjaman.php?id_peminjaman_masuk=$id_peminjaman_masuk&status=berhasildihapus')</script>";
    }else{
        echo "<script>location.replace('form_peminjaman.php?id_peminjaman_masuk=$id_peminjaman_masuk&status=gagaldihapus')</script>";
    }
?>