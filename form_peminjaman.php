        ...
        if($id_peminjaman_masuk != null){
            ...
            <script>
                if (confirm('Do you want clean this form?')) {
                    ...
                    location.replace('biodata_form.php?edit=true&id_peminjaman_masuk=$id_peminjaman_masuk');
                }
            </script>";
        }else{
            echo "
            <script>
                if (confirm('Do you want clean this form?')) {
                    ...
                    location.replace('biodata_form.php?nama_instansi=$nama_instansi&nama_kegiatan=$nama_kegiatan&email_peminjam=$email_peminjam');
                }
            </script>";
        }
                ...
                <div class="row">
                    <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form action="form_pemminjman.php" method="post" name="frm" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="email_peminjam" placeholder="Email Peminjam" class="form-control" value="<?php echo $email_peminjam; ?>"><small class="form-text text-muted">Masukkan Email Peminjam</small></div>
                                        </div>
                                        <div class="row form-group">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="tgl_ambil" placeholder="Tanggal Ambil" class="form-control" value="<?php echo $tgl_ambil; ?>"><small class="help-block form-text">Masukkan Tanggal Ambil</small></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Kembali</label></div>
                                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="tgl_kembali" placeholder="Tanggal Kembali" class="form-control" value="<?php echo $tgl_kembali; ?>"><small class="help-block form-text">Masukkan Tanggal Kembali</small></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor WhatsApp Peminjam</label></div>
                                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="no_wa" placeholder="Nomor WhatsApp Peminjam" class="form-control" value="<?php echo $no_wa; ?>"><small class="help-block form-text">Masukkan Nomor WhatsApp Peminjam</small></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Status</label></div>
                                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="status" placeholder="Nomor WhatsApp Peminjam" class="form-control" value="<?php echo $status; ?>"><small class="help-block form-text">Status</small></div>
                                        </div>
