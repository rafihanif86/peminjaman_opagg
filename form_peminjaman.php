<?php 
    ...
    $id_peminjaman_masuk = $nama_instansi = $nama_peminjam = $nik = $nama_kegiatan = $lampiran_surat = $edit = $email_peminjam = $tgl_ambil = $tgl_kembali =  $no_wa = $status = $edit  = $foto_surat = null;
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="form_peminjaman.php" method="post" name="frm" enctype="multipart/form-data"
                            ...
                            <div class="card-body card-block">
                                <div class="container">
                                    ...
                                    <div class="row form-group" <?php if($_SESSION['status'] != "admin"){ echo "hidden"; } ?>>
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="status" class="form-control">
                                                ...
                                                <option <?php if($status == "baru") {echo "selected";} ?> value="baru">
                                                    Baru
                                                </option>
...
if(isset($_POST["submit"])){
    ...
    if($sql_insert1 && $status1 == ""){
        echo "<script> location.replace('form_peminjaman.php?id_peminjaman_masuk=$id_peminjaman_masuk&status=berhasil')</script>";
    }else if($sql_insert1  && $status != ""){
        echo "<script> location.replace('form_peminjaman.php?id_peminjaman_masuk=$id_peminjaman_masuk&status=$status1')</script>";
    }else{
        echo "<script> location.replace('form_peminjaman.php?id_peminjaman_masuk=$id_peminjaman_masuk&status=gagal')</script>";
    }
