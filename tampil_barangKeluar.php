                ...
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1>Berita Acara Barang Keluar</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card" id="div1">
                        <img src="images/KERTASKOPGG.png" class="card-img-top"
                            style="height: 50%; width: 100%; margin-left: auto; margin-right: auto;" alt="Kop Surat">
                        <div class="card-body card-block">
                            <div class="row ml-3 mr-3">
                                <div class="col">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input"
                                                class=" form-control-label">Tanggal Keluar</label></div>
                                        <div class="col-12 col-md-9">: <?php echo $tgl_keluar ?></div>
                                    </div>
