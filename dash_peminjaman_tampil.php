<?php
    ...
    $id_peminjaman_masuk = $nik = $nama_peminjam = $nama_kegiatan = $email_peminjam = $tgl_ambil = $tgl_kembali =  $no_wa = $lampiran_surat = $status = "";
    $jumlah_data = 0;
    $hidden_alert = "hidden";
    ...
    if($id_peminjaman_masuk != ""){
        ...
        if($jumlah_data > 0){
            $query3 = "SELECT * FROM peminjaman_masuk WHERE id_peminjaman_masuk = '$id_peminjaman_masuk';";
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-md-4">
                                                    <img src="images/<?php if($row2["foto_alat"] != "" || !empty($row2["foto_alat"]) || $row2["foto_alat"] != null ){echo $row2["foto_alat"];}else{echo "no_image.png";}?>"
                                                        class="card-img" alt="..." style="max-height:15rem;float:none;">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        <div class="row">
